...
int main(int argc, char* argv[]){
    ...
    // 参考5.11.4节
    // close系统调用将立即返回，TCP模块将丢弃被关闭的socket对应的TCP发送缓冲区中残留的数据
    // 同时给对方发送一个复位报文段（见3.5.2小节）。
    // 因此，这种情况给服务器提供了异常终止连接的方法
    ...
    http_conn::m_epollfd = epollfd; // 所有http_conn对象共享该值
